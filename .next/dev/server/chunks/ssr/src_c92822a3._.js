...
const ChatPanel = ()=>{
    ...
    const handleSend = async ()=>{
        ...
        try {
            const sources = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchSources"])();
            const selectedIds = sources.filter((s)=>s.selected).map((s)=>s.id);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatWithAI"])(userMessage, selectedIds, messages);
            setMessages([
                ...newMessages,
                {
                    role: "assistant",
