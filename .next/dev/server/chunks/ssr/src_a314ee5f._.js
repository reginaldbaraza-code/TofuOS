...
async function createJiraIssue(params) {
    // In a real app, this would be a server-side call to the Jira API
    // For now, we'll use a server action or API route to keep secrets safe
...
;
;
function CreateJiraModal({ open, onOpenChange, insight, onCreated }) {
    ...
    const [projectKey, setProjectKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
...
const ChatPanel = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getJiraConfig"])().then((c)=>setJiraConfigured(!!c?.configured));
    }, [
        jiraConfigModalOpen,
        createJiraModalOpen
    ]);
...
//# sourceMappingURL=src_a314ee5f._.js.map