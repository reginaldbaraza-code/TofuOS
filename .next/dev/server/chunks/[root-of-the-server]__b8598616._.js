...
async function POST(req) {
    try {
        const { data: { user } } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
        if (!user) {
        ...
        const { data: config, error: configError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('jira_configs').select('*').eq('user_id', user.id).single();
        ...
        const projectKey = params.projectKey || 'KAN'; // Fallback project key
        const issueType = params.issueType || 'Task';
        // Call the real Jira Cloud REST API
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8598616._.js.map