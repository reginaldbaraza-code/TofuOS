...
// Validate ../../src/app/api/jira/create-issue/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/jira/create-issue">> = Specific
  const handler = {} as typeof import("../../src/app/api/jira/create-issue/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
